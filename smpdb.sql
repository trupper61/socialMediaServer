...
# Privileges for `smpuser`@`localhost`

GRANT USAGE ON *.* TO `smpuser`@`localhost` IDENTIFIED BY PASSWORD '*B5455263EAB04BB9239DD4BAB84C0E9E3B120B21';

GRANT ALL PRIVILEGES ON `smpdb`.* TO `smpuser`@`localhost`;